...
Vehicle.prototype.setTireP = function(val){
	// pressure set to 0 to 100, which indicate percentage of pressure
	if(val>=10 && val<=100){
		console.log("setting tire pressure to " + val);
		this.tireP = val;
	}else if(val<=10){
	this.setSpeed(0);
	this.tireP = val;
				...
				"regions" : [
					{
						...
						"polygon": [
							...
							{"latitude": "30.24852", "longitude": "-97.74560"}
